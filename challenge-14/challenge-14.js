(function() {
    ...
    */
    ...
    console.log(
        numberObjects.indexOf() > -1
            ? 'Existe um obj{ number: 2 }eto { number: 2 } em numberObjects!'
            : 'Não existe um objeto { number: 2 } em numberObjects :('
    );
    console.log('O objeto { number: 2 } não é encontrado porque ele é uma referência para um novo objeto');
