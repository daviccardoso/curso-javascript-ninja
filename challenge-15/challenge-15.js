(function() {
  ...
  */
  ...
  var davi = new Person('Davi', 'Cardoso', 26);
  var larissa = new Person('Larissa', 'Cardoso', 30);
  var john = new Person('John', 'Smith', 42);
  ...
  */
  ...
  console.log(larissa.getFullName());
  ...
  */
  ...
  console.log(larissa.getFullName() + ' tem ' + larissa.getAge() + ' anos.');
