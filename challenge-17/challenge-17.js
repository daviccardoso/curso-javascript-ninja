(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Davi Cardoso'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'braziliense'));
    ...
    */
    ...
    console.log(
        text.replace(/(O Centauro de Luvas)/, function(textoCasado) {
            return textoCasado.toUpperCase();
        })
    );
