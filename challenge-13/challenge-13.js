(function() {
    ...
    */
    ...
    brasil.unshift('Acre', 'Roraima', 'Amazonas');
    console.log(brasil);
    ...
    */
    ...
    var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernambuco', 'Piauí', 'Sergipe', 'Rio Grande do Norte'];
    ...
    */
    ...
    var temMais7Letras = brasil.every(function(value) {
        return value.length > 7;
    });

    console.log(temMais7Letras ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
